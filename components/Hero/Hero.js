    ...
    >
      ...
      <div className="flex flex-col pt-40 md:pt-0 select-none">
        ...
        <h1 className={`${styles.heroName} text-white text-6xl font-semibold`}>
          ...
          <span className="staggered-reveal"> Vamsi</span>
        </h1>
        <p>
          <span
            ref={typedElementRef}
      ...
      <div
        className={`absolute w-full h-auto max-w-sm md:max-w-lg lg:max-w-md bottom-1.5 lg:right-12 2xl:right-16 ${styles.lottieMobileMargin}`}
        ref={lottieRef}
      />
    </section>
  );
